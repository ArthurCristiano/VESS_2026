...
type TranslationKey =
    ...
    | "reports.evaluationsSubtitle"
    | "reports.evaluationName"
    | "reports.evaluator"
    | "reports.region"
    | "reports.status"
    | "reports.actions"
    | "reports.manageEvaluation"
    | "reports.inactivateEvaluation"
    | "reports.actionFutureTask"
...
const translations: Record<Language, Record<TranslationKey, string>> = {
    "pt-BR": {
        ...
        "reports.evaluationsTitle": "Lista de avaliações",
        "reports.evaluationsSubtitle": "Consulte rapidamente as principais informações das avaliações cadastradas.",
        "reports.evaluationName": "Nome da Avaliação",
        "reports.evaluator": "Avaliador",
        "reports.region": "Região",
        "reports.status": "Status",
        "reports.actions": "Ações",
        "reports.manageEvaluation": "Gerenciar",
        "reports.inactivateEvaluation": "Inativar",
        "reports.actionFutureTask": "Ação será implementada em outra task",
        "reports.evaluationsError": "Falha ao carregar a lista de avaliações.",
    ...
    en: {
        ...
        "reports.evaluationsTitle": "Evaluation List",
        "reports.evaluationsSubtitle": "Quickly check the main information from registered evaluations.",
        "reports.evaluationName": "Evaluation Name",
        "reports.evaluator": "Evaluator",
        "reports.region": "Region",
        "reports.status": "Status",
        "reports.actions": "Actions",
        "reports.manageEvaluation": "Manage",
        "reports.inactivateEvaluation": "Inactivate",
        "reports.actionFutureTask": "Action will be implemented in another task",
        "reports.evaluationsError": "Failed to load the evaluation list.",
    ...
    es: {
        ...
        "reports.evaluationsTitle": "Lista de evaluaciones",
        "reports.evaluationsSubtitle": "Consulta rápidamente la información principal de las evaluaciones registradas.",
        ...
        "reports.manageEvaluation": "Gestionar",
        "reports.inactivateEvaluation": "Inactivar",
        "reports.actionFutureTask": "La acción se implementará en otra tarea",
        "reports.evaluationsError": "Error al cargar la lista de evaluaciones.",
