...
public class AmostraService extends CrudService<Long, Amostra, AmostraRepository> {
    ...
    public Page<Amostra> findFirstActiveSampleWithFilter(Long regiaoId, Pageable pageable) {
        return amostraRepository.findFirstActiveSampleOfEachAvaliacaoWithFilter(regiaoId, pageable);
    }

    public Page<Amostra> findAvaliacoesInBoundingBox(Long regiaoId, Double minLat, Double maxLat, Double minLon, Double maxLon, Pageable pageable) {
